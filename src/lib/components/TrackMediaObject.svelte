...
<div class="notification bg-black hover:bg-slate-900 text-white blurred has-shadow has-pointer-cursor py-2 px-1">
    <article class="media flex items-center" in:fade>
        ...
        <figure class="relative h-7 w-7 mr-2">
            <img class="object-cover h-7 w-7 bg-gradient-to-br from-slate-900 to-black" alt="Track Cover" src="{medium.image || getArtistImage(medium.artist) || '/uploads/albumcovers/happysunofyah.jpg'}" width="64" height="64">
