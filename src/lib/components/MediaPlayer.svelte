...
<header id="header-title" class="section">
    <h1 class="animated flipInX">
        <span class="orange-header">
            <p class="title is-uppercase is-size-6-mobile is-size-5-touch is-size-2-widescreen is-size-1-fullhd has-shadow">{medium.title} </p>
            <p class="subtitle is-uppercase is-size-7-mobile is-size-6-touch is-size-3-widescreen is-size-2-fullhd">by {medium.track_artist}</p>
        </span>
    </h1>
    {#if canPlay}
...
<section id="tube">
        ...
        <div class="tube-thumb">
            <figure class="image is-16by9">
                <div class="ytp-cued-thumbnail-overlay">
                    <!-- <div class="ytp-cued-thumbnail-overlay-image linkcast-thumb lazyload" style="background-image: url('{medium.cover_image ||  'https://lastmessengers.artkidsfoundation.org/wp-content/uploads/2022/09/happysunofyah.jpg'}');"></div> -->
    ...
    <audio autoplay id="audio"
        src={medium.media_file}
        bind:this={player}
        class:active={medium.src}
        on:change={() => setAudio()}
