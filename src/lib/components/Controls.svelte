<script>
	import { player, play, pause, toggleLoop, toggleShuffle, skip } from "$lib/mediaplayer";
	import { toggleMenu, UI, UIState } from "$lib/ui";
...
<nav class="control h-control-panel mx-auto px-5 lg:px-10 rounded-b-xl flex items-center justify-between text-white  transition-opacity duration-700 delay-0 opacity-0" class:opacity-100={!$player.playing || $UI.controls.visible} class:delay-1000={$player.playing}>
	<div class="tracklist opacity-75 hover:opacity-100" class:px-2={state == 'fullscreen'} >
	...
	<!-- <div class="shuffle cursor-pointer amplitude-shuffle opacity-75 hover:opacity-100" class:px-2={state == 'fullscreen'} class:text-yellow-400={$player.shuffle}
 ...
 -->
	...
	<!-- <div class="repeat cursor-pointer amplitude-repeat-song opacity-75 hover:opacity-100" class:px-2={state == 'fullscreen'}  class:text-yellow-400={$player.loop != 'no-repeat'}
		on:click={toggleLoop}
		title="Toggle repeat">
	...
	<div class="like cursor-pointer opacity-75 hover:opacity-100" class:px-2={ == 'fullscreen'}  id="song-saved">
